...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/habits"><ProtectedRoute><Layout><HabitTracker /></Layout></ProtectedRoute></Route>
      <Route path="/sleep"><ProtectedRoute><Layout><SleepTracker /></Layout></ProtectedRoute></Route>
      <Route path="/statistics"><ProtectedRoute><Layout><Statistics /></Layout></ProtectedRoute></Route>
      <Route path="/history"><ProtectedRoute><Layout><EmotionalHistory /></Layout></ProtectedRoute></Route>
